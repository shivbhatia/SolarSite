...
@Component({
  templateUrl: "./mysolarprojects.html",
})

export class mysolarprojectsComponent implements OnInit{
    model: any = {};
	result : any;
    token : any;
    public message = '';
    ...
    ngOnInit(){
        $('#mydiv').show();
        this.solarService.getmySolarProjects(<Solar>this.model).subscribe(result => { 
            this.result = result;
